...
<!--          头像加id-->
    ...
    <el-main>
      <el-row class="me-row" :gutter="20" type="flex" align="middle" style="margin-top: 100px">
        <el-col :span="5"  :offset="0"><div class="left-nav" style="border: 10px solid red" >
...
<!--                line height = height 居中-->
        ...
        <el-col :span="4"  ><div style="border: 10px solid black">
        ...
        <el-col :span="12" ><div style="border:3px solid blue">
            <div class="personalInfo" style="margin: 0 auto; border: 2px solid blueviolet">
              <div class="upper-lever" style="height: 75%; box-sizing: border-box; border: #00DBDE 1px solid;padding: 40px 20px" >
